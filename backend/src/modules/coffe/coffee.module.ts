...
import { CREATE_COFFEE_USE_CASE, GET_ALL_COFFEES_USE_CASE, GET_COFFEE_BY_ID_USE_CASE, GET_COFFEE_BY_NAME_USE_CASE, UPDATE_COFFEE_USE_CASE, DELETE_COFFEE_USE_CASE } from './use-case.tokens';
import { COFFEE_PROVIDERS } from 'src/providers/coffe-providers/coffe.provider';
...
@Module({
  ...
  exports: [COFFEE_REPOSITORY_TOKEN,COFFEE_REPOSITORY_TOKEN,
      CoffeeDomainService,
